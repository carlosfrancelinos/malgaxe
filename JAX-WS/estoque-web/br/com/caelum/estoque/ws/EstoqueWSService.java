 ...
 * 2019-12-12T08:17:49.196-03:00
 * Generated source version: 2.7.7
 * 
 */
@WebServiceClient(name = "EstoqueWSService", 
                  wsdlLocation = "file:/home/cfrancelino/Alura/JAX-WS/estoque-web/src/EstoqueWSServiceCap5.wsdl",
...
public class EstoqueWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/cfrancelino/Alura/JAX-WS/estoque-web/src/EstoqueWSServiceCap5.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EstoqueWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/cfrancelino/Alura/JAX-WS/estoque-web/src/EstoqueWSServiceCap5.wsdl");
        }
        WSDL_LOCATION = url;
    }
